...
void Send_Data_New(ValueStruct* num)
{
    ...
    SEND_BUF_NEW[2]=(u8)num->SetupType;/*数据类型*/
    SEND_BUF_NEW[3]=(u8)num->ValueType;/*整形or浮点*/
    SEND_BUF_NEW[4] = num->Num.char_form[0] ;
    SEND_BUF_NEW[5] = num->Num.char_form[1] ;
    SEND_BUF_NEW[6] = num->Num.char_form[2] ;
    SEND_BUF_NEW[7] = num->Num.char_form[3] ;
