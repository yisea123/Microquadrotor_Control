...
void Send_Array_MATLAB(u8 * Array, u16 Len)
{
    HAL_UART_Transmit(&huart1, Array, Len, 100);
}
/******************************************************************************
            ...
            switch (USART_Old[8])
            {
                ...
                case Rec_Set_Anlge:
                    SA = (float)usart_temp / 1024;
										//RollSet = (float)usart_temp / 1024;
								PidRollAngle.U = (float)usart_temp / 1024;
                    break;
...
//        char cData = 0;
////        u8 cCRC[11] = {0};
//				SEND_BUF_MATLAB[0] = 0x55;
//	
////        putchar(0x55);     cCRC[0]=0x55;
////        putchar(chrType);  cCRC[1]=chrType;       
////        cData = ax;     putchar(cData);  cCRC[3]=cData;
////        cData = ax>>8;  putchar(cData);  cCRC[4]=cData;
////        cData = ay;     putchar(cData);  cCRC[5]=cData;
////        cData = ay>>8;  putchar(cData);  cCRC[6]=cData;
////        cData = az;     putchar(cData);  cCRC[7]=cData;
////        cData = az>>8;  putchar(cData);  cCRC[8]=cData;        
////        cData = t;      putchar(cData);  cCRC[9]=cData;
////        cData = t>>8;   putchar(cData);  cCRC[10]=cData;
////        //putchar(cCRC);      
////        HAL_UART_Transmit(&huart1, cCRC, 11, 100);	
//}
